...
use DTS\eBaySDK\MerchantData\Enums\ApplicationDeviceTypeCodeType;
...
class ApplicationDeviceTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\ApplicationDeviceTypeCodeType', $this->obj);
    }
}
