...
use DTS\eBaySDK\MerchantData\Enums\ItemFormatSortFilterCodeType;
...
class ItemFormatSortFilterCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\ItemFormatSortFilterCodeType', $this->obj);
    }
}
