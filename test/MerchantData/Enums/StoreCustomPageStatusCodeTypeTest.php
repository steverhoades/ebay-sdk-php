...
use DTS\eBaySDK\MerchantData\Enums\StoreCustomPageStatusCodeType;
...
class StoreCustomPageStatusCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\StoreCustomPageStatusCodeType', $this->obj);
    }
}
