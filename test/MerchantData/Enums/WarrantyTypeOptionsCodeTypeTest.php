...
use DTS\eBaySDK\MerchantData\Enums\WarrantyTypeOptionsCodeType;
...
class WarrantyTypeOptionsCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\WarrantyTypeOptionsCodeType', $this->obj);
    }
}
