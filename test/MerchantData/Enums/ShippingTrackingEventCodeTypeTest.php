...
use DTS\eBaySDK\MerchantData\Enums\ShippingTrackingEventCodeType;
...
class ShippingTrackingEventCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\ShippingTrackingEventCodeType', $this->obj);
    }
}
