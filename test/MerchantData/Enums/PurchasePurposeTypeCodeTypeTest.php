...
use DTS\eBaySDK\MerchantData\Enums\PurchasePurposeTypeCodeType;
...
class PurchasePurposeTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\PurchasePurposeTypeCodeType', $this->obj);
    }
}
