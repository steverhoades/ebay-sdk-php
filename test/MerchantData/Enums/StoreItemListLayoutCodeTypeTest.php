...
use DTS\eBaySDK\MerchantData\Enums\StoreItemListLayoutCodeType;
...
class StoreItemListLayoutCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\StoreItemListLayoutCodeType', $this->obj);
    }
}
