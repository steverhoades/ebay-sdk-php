...
use DTS\eBaySDK\MerchantData\Enums\DisputeMessageSourceCodeType;
...
class DisputeMessageSourceCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\DisputeMessageSourceCodeType', $this->obj);
    }
}
