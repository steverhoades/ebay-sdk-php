...
use DTS\eBaySDK\MerchantData\Enums\EndOfAuctionLogoTypeCodeType;
...
class EndOfAuctionLogoTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\EndOfAuctionLogoTypeCodeType', $this->obj);
    }
}
