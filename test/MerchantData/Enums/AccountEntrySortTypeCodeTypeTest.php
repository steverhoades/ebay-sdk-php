...
use DTS\eBaySDK\MerchantData\Enums\AccountEntrySortTypeCodeType;
...
class AccountEntrySortTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\AccountEntrySortTypeCodeType', $this->obj);
    }
}
