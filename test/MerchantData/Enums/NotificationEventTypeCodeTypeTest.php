...
use DTS\eBaySDK\MerchantData\Enums\NotificationEventTypeCodeType;
...
class NotificationEventTypeCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\NotificationEventTypeCodeType', $this->obj);
    }
}
