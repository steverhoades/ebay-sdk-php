...
use DTS\eBaySDK\MerchantData\Enums\PaymentMethodSearchCodeType;
...
class PaymentMethodSearchCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\PaymentMethodSearchCodeType', $this->obj);
    }
}
