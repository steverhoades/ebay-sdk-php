...
use DTS\eBaySDK\MerchantData\Enums\FeedbackRatingDetailCodeType;
...
class FeedbackRatingDetailCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\FeedbackRatingDetailCodeType', $this->obj);
    }
}
