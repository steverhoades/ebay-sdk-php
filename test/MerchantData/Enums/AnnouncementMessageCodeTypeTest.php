...
use DTS\eBaySDK\MerchantData\Enums\AnnouncementMessageCodeType;
...
class AnnouncementMessageCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\AnnouncementMessageCodeType', $this->obj);
    }
}
