...
use DTS\eBaySDK\MerchantData\Enums\ReturnsWithinOptionsCodeType;
...
class ReturnsWithinOptionsCodeTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('\DTS\eBaySDK\MerchantData\Enums\ReturnsWithinOptionsCodeType', $this->obj);
    }
}
